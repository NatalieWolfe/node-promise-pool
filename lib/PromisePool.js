...
/**
 * @type PromisePool.CreateResourceMethod
 *
...
/**
 * @type PromisePool.DestroyResourceMethod
 *
...
/**
 * @type PromisePool.ValidateResourceMethod
 *
...
/**
 * @type PromisePool.Factory
 *
 * @property {String} name
 *  Name of the  Serves only logging purposes.
 *
 * @property {PromisePool.CreateResourceMethod} create
 *  Should create the item to be acquired, and return either a promise or the new client.
 *
 * @property {PromisePool.DestroyResourceMethod} destroy
 *  Should gently close any resources that the item is using. Called to destroy resources.
 *
 * @property {PromisePool.ValidateResourceMethod} validate
