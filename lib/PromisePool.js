...
function _dispense() {
    ...
    if (waitingCount > 0) {
        while (this._availableObjects.length > 0 && this._waitingClients.length) {
...
/**
 * @readonly
 * @member {number} PromisePool.prototype.length - The total number of resources in the pool.
 */
...
/**
 * @readonly
 * @member {string} PromisePool.prototype.name - The name of the pool, as provided in the factory.
 */
