 ...
 * @param {string} level    - The logging priority/level.
 *
 * @return {undefined}
 */
...
PromisePool.prototype.release = function(obj) {
    ...
    if (obj.__promisePool_destroyed) {
        ...
        if (this._opts.onRelease) {
            return Promise.resolve(this._opts.onRelease(obj)).then(function() {
                _release();
                process.nextTick(_dispense.bind(self));
                _scheduleRemoveIdle.call(self);
            }, function(err) {
